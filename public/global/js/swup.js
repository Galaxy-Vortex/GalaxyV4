...
`;
  ...
  // Check if localStorage has a value for autoAB, if not set it to true

  document.getElementById("autoABToggle").innerHTML =
    localStorage.getItem("autoAB") == "true" ? "Disable" : "Enable";
