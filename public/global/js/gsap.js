...
!(function (t, e) {
    ...
    Rt =
      ...
      (g = {
        ...
        remove: function remove(t, e) {
          ~(e = Y.indexOf(t)) && Y.splice(e, 1) && e <= O && O--;
        },
        _listeners: (Y = []),
      })),
    Ft = function _wake() {
  ...
  function yl(t) {
    ...
    if (
      ...
      for (O = 0; O < Y.length; O++) Y[O](i, b, n, t);
  }
  function gn(t) {
    return t < j
      ? B * t * t
  ...
  var Nt,
    ...
    Qt = function _initTween(t, e, r) {
      ...
      if (
        (!D || (k && g) || (g = "none"),
        (t._ease = jt(g, V.ease)),
        (t._yEase = O ? Bt(jt(!0 === O ? g : O, V.ease)) : 0),
        O &&
          t._yoyo &&
          !t._repeat &&
  ...
  ($t.version = Xt.version = ze.version = "3.13.0"), (o = 1), x() && Ft();
  function vd(t, e) {
  ...
  function be(t, e, r, i) {
    ...
    if (
      ...
      (r += ""),
      "var(--" === (i += "").substring(0, 6) &&
        (i = Pd(t, i.substring(4, i.indexOf(")")))),
      "auto" === i &&
        ((f = t.style[e]),
        (t.style[e] = i),
        (i = Pd(t, e) || i),
